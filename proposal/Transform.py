...
from proposal.ResidualNet import *
from proposal.Attention import *
from proposal.SELayer import SELayer
from proposal.AttentionLayers import CBAM,resSELayer
from proposal.Enhancement import *
...
class Synthesis_transform(torch.nn.Module):
    def __init__(self,num_filters=256,out_filters=320):
        ...
        self.UpLayerA = nn.Sequential(
            ...
            nn.LeakyReLU(inplace=True),
            nn.ConvTranspose2d(num_filters,num_filters,5,stride=2,groups=num_filters,padding=2,output_padding=1),
            nn.LeakyReLU(inplace=True),
            resSELayer(num_filters),
